...
@section('content')
    ...
    <div class="container" id="admin-product-container">
        ...
        <div class="col-md-12">
                ...
                {!! Form::model($product, ['route' => ['admin.product.update', $product], 'method' =>'POST', 'files' => true])!!}
                {{ csrf_field() }}
                ...
                <div class="col-md-12" id="category-dropdown-container">
                    ...
                    <div class="col-sm-6 col-md-6" id="Product-Input-Field">
                        <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="price" value="{{ old('price') ? : $product->price }}" placeholder="Product Price">
                            </div>
                            @if($errors->has('price'))
                    ...
                    <div class="col-sm-6 col-md-6" id="Product-Input-Field">
                        <div class="form-group{{ $errors->has('reduced_price') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon"><i class="material-icons">attach_money</i></div>
                                <input type="text" class="form-control" name="reduced_price" value="{{ old('reduced_price')? : $product->reduced_price }}" placeholder="Product Reduced Price">
                            </div>
                ...
                <div class="col-sm-3 col-md-3" id="Product-Input-Field">
                    <div class="form-group{{ $errors->has('product_qty') ? ' has-error' : '' }}">
                        ...
                        <input type="number" class="form-control" name="product_qty" value="{{ old('product_qty')? : $product->product_qty }}" placeholder="Add Product Quantity" min="0">
                ...
                <div class="col-sm-6 col-md-6" id="Product-Input-Field">
                    <div class="form-group{{ $errors->has('product_sku') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" name="product_sku"  id="product_sku" value="{{ old('product_sku')? : $product->product_sku }}" placeholder="Generate Product SKU" >
                    ...
                    @if (isset($product) && $product->photo !== '')
                        <div class="row">
                            <div class="col-md-6">
                                <p>Current photo:</p>
                                <div class="thumbnail">
                                    <img src="{{ url('/src/public/img/products/' . $product->photo) }}" class="img-rounded">
                                </div>
                            </div>
                        </div>
                    @endif
