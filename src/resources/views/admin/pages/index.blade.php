        ...
        <div class="container-fluid" id="Admin_Dashboard_Container">
            <div class="row" id="Admin_Dashboard_Row">
                ...
                <div class="col-lg-12" id="Admin_Dashboard-col-md-12">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading default-color white-text"><i class="fa fa-users" aria-hidden="true"></i> &nbsp;Clients</div>
                                <div class="panel-body">
                                    <div style="overflow: auto; height: 275px;">
                ...
                <div class="col-lg-12" id="Admin_Dashboard-col-md-12">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading default-color white-text"><i class="fa fa-users" aria-hidden="true"></i> &nbsp;Drivers</div>
                            <div class="panel-body">
                                <div style="overflow: auto; height: 275px;">
                                    @include('admin.pages.partials.driver')
                                </div>
                            </div>
