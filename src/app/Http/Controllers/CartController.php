...
class CartController extends Controller
{
    ...
    public function showCart()
    {
        ...
        return view('cart.cart', compact('user', 'search', 'categories', 'count', 'cart_count'))
    ...
    public function addCart()
    {
        ...
        if ($product->user()->find($user_id)) {
            $total = $qty * $product->user()->find($user_id)->pivot->price;
        } else {
        ...
        //if product exist
        if (Cart::where('user_id', '=', $user_id)->where('product_id', '=', $product_id)->first()) {
            //flash()->overlay('Info', 'the product existe  ');
            $cartExist->update(array(
                'user_id' => $cartExist->user_id,
                'product_id' => $cartExist->product_id,
                'qty' => $qty,
                'total' => $total
            ));
