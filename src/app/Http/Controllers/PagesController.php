...
class PagesController extends Controller {
    ...
    public function index() {
       ...
       // dd($user);
        ...
        //$new = Product::orderBy('created_at', 'desc')->where('featured', '=', 0)->take(4)->get();
        if($user){
        ...
        //dd($product->user()->find($user->id));


       return view('pages.index', compact('products', 'brands', 'search', 'new', 'cart_count', 'rand_brands'))
